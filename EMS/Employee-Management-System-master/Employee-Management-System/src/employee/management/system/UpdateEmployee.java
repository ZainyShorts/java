...
public class UpdateEmployee extends JFrame implements ActionListener{
    ...
    JTextField tfeducation, tffname, tfaddress, tfphone, tfcnic, tfemail, tfsalary ;
    JLabel lblempId;
    JButton add, back;
    String emp_id;
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try {
                Conn conn = new Conn();
                String query = "update employee set father_name = '"+fname+"', salary = '"+salary+"', address = '"+address+"', phone = '"+phone+"', email =  '"+email+"', education = '"+education+"' where emp_id = '"+emp_id+"'";

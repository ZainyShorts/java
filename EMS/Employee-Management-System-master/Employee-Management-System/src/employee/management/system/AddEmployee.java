...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    JTextField tfname, tffname, tfaddress, tfphone, tfcnic, tfemail, tfsalary;
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try {
                Conn conn = new Conn();
                String query = "insert into employee values('"+emp_id+"', '"+name+"', '"+father_name+"', '"+address+"', '"+phone+"', '"+cnic+"', '"+email+"', '"+salary+"', '"+education+"' )";
